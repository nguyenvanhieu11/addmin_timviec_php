...
class C_quanlybinhluan_tt extends CI_Controller
{
    ...
    public function index($page=0){
        ...
        $config['base_url'] = site_url('c_quanlybinhluan_tt/index');
        //+ Cấu hình tổng số dòng cần phân trang
        $config['total_rows'] = $this->db->count_all('binhluan_tintuc');
        ...
        $data['bl_tintuc']=$this->M_tintuc->getAllbinhluan($config['per_page'],$page);
        $this->template->load('master_layout','connects','tintuc/v_quanlybinhluan',$data);
    }
}