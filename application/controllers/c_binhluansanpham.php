...
class C_binhluansanpham extends CI_Controller
{
    ...
    public function index($page=0){
        ...
        $config['base_url'] = site_url('c_binhluansanpham/index');
        //+ Cấu hình tổng số dòng cần phân trang
        $config['total_rows'] = $this->db->count_all('danh_gia_va_bl');
        ...
        $data["comment"]=$this->M_sanpham->getAllcomment($config['per_page'],$page);
        $this->template->load('master_layout','connects','sanpham/v_binhluansanpham',$data);
    }
}