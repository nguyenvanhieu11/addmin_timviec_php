...
class C_quanlytintuc extends CI_Controller
{
    ...
    public function  index($page=0){
        ...
        $config['base_url'] = site_url('c_quanlytintuc/index');
        ...
        $data['binhluantintuc']=$this->M_tintuc->getcountbltintuc($config['per_page'],$page);
        $this->template->load('master_layout','connects','tintuc/v_quanlytintuc',$data);
    }

    public function delete($id){
        $this->M_tintuc->delete($id);
