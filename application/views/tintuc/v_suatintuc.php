            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?=site_url('c_themtintuc/themtintuc')?>">
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="first-name" required class="form-control col-md-7 col-xs-12" name="tentintuc" value="<?=$tintucid->ten_tin_tuc?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="last-name" name="tentomtat" required
                               class="form-control col-md-7 col-xs-12" value="<?=$tintucid->ten_tom_tat?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Nội dung tóm tắt </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="noidungtomtat"  value="<?=$tintucid->nd_tom_tat?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea class="date-picker form-control col-md-7 col-xs-12" rows="3" required placeholder="Nội dung chi tiết tin tức  ..." name="noidungchitiet"> <?=$tintucid->noidung_chitiet?></textarea>
                    </div>
                </div>
                <div class="form-group">
