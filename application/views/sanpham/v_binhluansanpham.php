<div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row">
                <form method="post" action="v_dondathang.php">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="input-group">
                            <input type="email" name="date" class="form-control" id="dateorder" placeholder="Search for...">
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="x_panel">
        <div class="x_title">
            <h4>Quản lý bình luận sản phẩm</h4>
            ...
            <div class="table-responsive">
                <table class="table table-striped jambo_table bulk_action">
                    ...
                    <tr class="even pointer">
                        ...
                        <td class=" "><?=$cmt->ten_sp?></td>
                        <td class=" "><?=$cmt->nguoi_binh_luan?></td>
                        <td class=" "><?=$cmt->email?></td>
                        <td class=" "><?=$cmt->noi_dung_bl?></td>
                        <td class=" "><?=$cmt->ngaybinh_luan?></td>
                        <td class=" "><?=$cmt->phan_hoi?></td>
                        <td class=" last">
                            <button type="button" class="btn btn-danger"><a href="<?=site_url('c_phanhoi_binhluan_sp/delete/'.$cmt->id)?>" style="color:#fff;" onclick="return confirm('bạn có chắc chắn muốn xóa bình luận này ?')">xóa</a></button>
                            <button type="button" class="btn btn-info">
                                <a href="<?=site_url('c_phanhoi_binhluan_sp')?>/binhluan/<?=$cmt->id?>" style="color:#fff;">Phản hồi</a>
                            </button>
                        </td>
                    </tr>
                    <?php }?>
