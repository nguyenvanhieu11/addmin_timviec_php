	 ...
	 */
	    ...
	    echartsProto.getConnectedDataURL = function (opts) {
	        ...
	        if (connectedGroups[groupId]) {
	            ...
	            return targetCanvas.toDataURL('products/' + (opts && opts.type || 'png'));
	        }
	        else {
	 ...
	 */
	    ...
	    ZImage.prototype = {
	        ...
	        brush: function (ctx) {
	            ...
	            // style.products is a url string
	            if (typeof src === 'string') {
	                image = this._image;
	            }
	            // style.products is an HTMLImageElement or HTMLCanvasElement or Canvas
	            else {
	                image = src;
	            }
	            // FIXME Case create many images with src
	            if (!image && src) {
	                // Try get from global products cache
	            ...
	            if (image) {
	                // 图片已经加载完成
	                // if (products.nodeName.toUpperCase() == 'IMG') {
	...
	// Global defines
	    ...
	    ZRender.prototype = {
	        ...
	        */
	        ...
	        /**
	         * Converting a path to products.
	         * It has much better performance of drawing products rather than drawing a vector path.
	    ...
	    Painter.prototype = {
	        ...
	        getRenderedCanvas: function (opts) {
	            ...
	            for (var i = 0; i < displayList.length; i++) {
	                ...
	                if (!el.invisible) {
	                    el.beforeBrush && el.beforeBrush(ctx);
	                    // TODO Check products cross origin
	                    el.brush(ctx, false);
	                    el.afterBrush && el.afterBrush(ctx);
	                }
	            }
	...
	// Symbol factory
	    ...
	    var symbolUtil = {
	        ...
	        createSymbol: function (symbolType, x, y, w, h, color) {
	            ...
	            if (symbolType.indexOf('products://') === 0) {
